...
def add_infer_densecls_options(parser):
    group = parser.add_argument_group('infer_dense_cls')
    group.add_argument("--cls_model_path", type=str, help="Dense CLS model path")
    
def add_dense_cls_options(parser):
    group = parser.add_argument_group('dense_cls')
    group.add_argument("--sin_path", default="", type=str, help="Sampled motion data path")
    group.add_argument("--cls_model_path", type=str, help="Dense CLS model path")
...
def add_diffusion_options(parser):
    ...
    group.add_argument("--diffusion_steps", default=10, type=int,
...
def add_model_options(parser):
    ...
    group.add_argument("--arch", default='cosmos',
                       choices=['cosmos', 'unet'], type=str,
    ...
    group.add_argument("--num_densecond_dim", default=3, type=int, help="")
...
def add_data_options(parser):
    ...
    group.add_argument("--pkl_path", default="", type=str,
...
def create_synthdatset_args():
    parser = ArgumentParser()
    add_base_options(parser)
    add_sampling_options(parser)
    add_generate_options(parser)
    add_infer_densecls_options(parser)
    
    return parse_and_load_from_model(parser)

def train_sinmdm_args():
    parser = ArgumentParser()
    add_base_options(parser)
    add_data_options(parser)
    add_model_options(parser)
